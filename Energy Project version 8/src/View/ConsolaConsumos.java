...
public class ConsolaConsumos {
        ...
        do {
            ...
            try {
                ...
                switch (opcion) {
                    ...
                    case 8 -> calcularFacturaMes();
                    case 9 -> System.out.println("Saliendo del menú de consumos...");
    ...
    private void mostrarOpcionesMenu() {
        ...
        System.out.println("8. Calcular valor factura de un mes");
    ...
    private void calcularFacturaMes() {
        System.out.print("Mes: ");
        String mes = scanner.nextLine();
        System.out.print("ID Cliente: ");
        String idCliente = scanner.nextLine();
    
        double total = controlador.calcularValorFactura(mes, idCliente);
        System.out.println("Valor total de la factura en " + mes + ": $" + total);
    }
